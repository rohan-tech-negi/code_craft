...
// Glot.io language map — https://glot.io/new
// Each entry: { language, version, filename }
export const GLOT_LANGUAGE_MAP: Record<
  string,
  { language: string; version: string; filename: string }
> = {
  javascript: { language: "javascript", version: "latest", filename: "main.js" },
  typescript: { language: "typescript", version: "latest", filename: "main.ts" },
  python:     { language: "python",     version: "latest", filename: "main.py" },
  java:       { language: "java",       version: "latest", filename: "Main.java" },
  go:         { language: "go",         version: "latest", filename: "main.go" },
  rust:       { language: "rust",       version: "latest", filename: "main.rs" },
  cpp:        { language: "cpp",        version: "latest", filename: "main.cpp" },
  csharp:     { language: "csharp",     version: "latest", filename: "main.cs" },
  ruby:       { language: "ruby",       version: "latest", filename: "main.rb" },
  swift:      { language: "swift",      version: "latest", filename: "main.swift" },
};
